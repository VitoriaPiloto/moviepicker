...
import { useFocusEffect, useNavigation } from '@react-navigation/native'; // Para recarregar quando a tela ganhar foco

export default function MovieList() {
  const [movieList, setMovieList] = useState([]);
  const navigate = useNavigation();

  function MoverParaProxima(item){
    console.log("ITEM");
    console.log(item);
    ...
    return(
      navigate.navigate('MovieDetails', {
          ...
          movieAvarage: item.rating,
          overview: item.overview,
          poster: item.poster,
          providerIds: item.ids,
          providerNames: item.names,
          providerLogos: item.logos,
